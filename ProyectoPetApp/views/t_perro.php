...
<body>
  ...
  <div id="cat" class="about-us section">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="section-heading">
            <h4>TEAM <em>PERRO</em></h4>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="gradient-button">
                <a href="./fomulario.php">SIGENTE</a>
              </div>
              <div class="gradient-button">
